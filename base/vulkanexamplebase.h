...
//
  ...
  *
  * @note Virtual, can be overriden by derived example class for custom instance
  * creation
  */
  ...
  /** @brief (Virtual) Called before the UI overlay is created, can be used to
   * do a custom setup e.g. with different renderpass */
