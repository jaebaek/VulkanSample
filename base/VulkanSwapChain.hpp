...
// Create the os-specific surface
    ...
    err =
        vkCreateIOSSurfaceMVK(instance, &surfaceCreateInfo, nullptr, &surface);
  ...
  */
  void create(uint32_t *width, uint32_t *height, bool vsync = false) {
    ...
    // If width (and height) equals the special value 0xFFFFFFFF, the size of
    // the surface will be set by the swapchain
    ...
    // Set additional usage flag for blitting from the swapchain images if
    // supported
    VkFormatProperties formatProps;
    vkGetPhysicalDeviceFormatProperties(physicalDevice, colorFormat,
                                        &formatProps);
  ...
  */
  VkResult acquireNextImage(VkSemaphore presentCompleteSemaphore,
    ...
    // has been acquired or an actual error is thrown
