/*
* Vulkan Example - Physical based rendering a textured object (metal/roughness
...
public:
  ...
  void loadAssets() {
    textures.environmentCube.loadFromFile(
        ASSET_PATH "textures/hdr/gcanyon_cube.ktx",
        VK_FORMAT_R16G16B16A16_SFLOAT, vulkanDevice, queue);
    models.skybox.loadFromFile(ASSET_PATH "models/cube.obj", vertexLayout, 1.0f,
                               vulkanDevice, queue);
    // PBR model
    models.object.loadFromFile(ASSET_PATH "models/cerberus/cerberus.fbx",
                               vertexLayout, 0.05f, vulkanDevice, queue);
    textures.albedoMap.loadFromFile(ASSET_PATH "models/cerberus/albedo.ktx",
                                    VK_FORMAT_R8G8B8A8_UNORM, vulkanDevice,
                                    queue);
    textures.normalMap.loadFromFile(ASSET_PATH "models/cerberus/normal.ktx",
                                    VK_FORMAT_R8G8B8A8_UNORM, vulkanDevice,
                                    queue);
    textures.aoMap.loadFromFile(ASSET_PATH "models/cerberus/ao.ktx",
                                VK_FORMAT_R8_UNORM, vulkanDevice, queue);
    textures.metallicMap.loadFromFile(ASSET_PATH "models/cerberus/metallic.ktx",
                                      VK_FORMAT_R8_UNORM, vulkanDevice, queue);
    textures.roughnessMap.loadFromFile(ASSET_PATH
  ...
  void setupDescriptors() {
    ...
    std::vector<VkWriteDescriptorSet> writeDescriptorSets = {
        ...
        vks::initializers::writeDescriptorSet(
            descriptorSets.object, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 5,
            &textures.albedoMap.descriptor),
        vks::initializers::writeDescriptorSet(
            descriptorSets.object, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 6,
            &textures.normalMap.descriptor),
        vks::initializers::writeDescriptorSet(
            descriptorSets.object, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 7,
            &textures.aoMap.descriptor),
        vks::initializers::writeDescriptorSet(
            descriptorSets.object, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 8,
            &textures.metallicMap.descriptor),
        vks::initializers::writeDescriptorSet(
            descriptorSets.object, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 9,
  ...
  void preparePipelines() {
    ...
    shaderStages[0] =
        loadShader(ASSET_PATH "shaders/pbrtexture/skybox.vert.spv",
                   VK_SHADER_STAGE_VERTEX_BIT);
    shaderStages[1] =
        loadShader(ASSET_PATH "shaders/pbrtexture/skybox.frag.spv",
    ...
    shaderStages[0] =
        loadShader(ASSET_PATH "shaders/pbrtexture/pbrtexture.vert.spv",
                   VK_SHADER_STAGE_VERTEX_BIT);
    shaderStages[1] =
        loadShader(ASSET_PATH "shaders/pbrtexture/pbrtexture.frag.spv",
                   VK_SHADER_STAGE_FRAGMENT_BIT);
  ...
  void generateBRDFLUT() {
    ...
    shaderStages[0] =
        loadShader(ASSET_PATH "shaders/pbrtexture/genbrdflut.vert.spv",
                   VK_SHADER_STAGE_VERTEX_BIT);
    shaderStages[1] =
        loadShader(ASSET_PATH "shaders/pbrtexture/genbrdflut.frag.spv",
                   VK_SHADER_STAGE_FRAGMENT_BIT);
    VkPipeline pipeline;
    VK_CHECK_RESULT(vkCreateGraphicsPipelines(device, pipelineCache, 1,
  ...
  void generateIrradianceCube() {
    ...
    shaderStages[0] =
        loadShader(ASSET_PATH "shaders/pbrtexture/filtercube.vert.spv",
                   VK_SHADER_STAGE_VERTEX_BIT);
    shaderStages[1] =
        loadShader(ASSET_PATH "shaders/pbrtexture/irradiancecube.frag.spv",
                   VK_SHADER_STAGE_FRAGMENT_BIT);
    VkPipeline pipeline;
    VK_CHECK_RESULT(vkCreateGraphicsPipelines(device, pipelineCache, 1,
                                              &pipelineCI, nullptr, &pipeline));
  ...
  void generatePrefilteredCube() {
    ...
    shaderStages[0] =
        loadShader(ASSET_PATH "shaders/pbrtexture/filtercube.vert.spv",
                   VK_SHADER_STAGE_VERTEX_BIT);
    shaderStages[1] =
        loadShader(ASSET_PATH "shaders/pbrtexture/prefilterenvmap.frag.spv",
                   VK_SHADER_STAGE_FRAGMENT_BIT);
    VkPipeline pipeline;
    VK_CHECK_RESULT(vkCreateGraphicsPipelines(device, pipelineCache, 1,
                                              &pipelineCI, nullptr, &pipeline));
