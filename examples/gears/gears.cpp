...
public:
  ...
  void prepareVertices() {
    ...
    std::vector<glm::vec3> positions = {glm::vec3(-3.0, 0.0, 0.0),
  ...
  void preparePipelines() {
    ...
    shaderStages[0] =
        loadShader(getAssetPath() + "shaders/gears/gears.vert.spv",
                   VK_SHADER_STAGE_VERTEX_BIT);
    shaderStages[1] =
        loadShader(getAssetPath() + "shaders/gears/gears.frag.spv",
