...
// TODO: separate transfer queue (if not supported by compute queue) including
    ...
    */
    ...
    // Copy input data to VRAM using a staging buffer
    {
      createBuffer(VK_BUFFER_USAGE_TRANSFER_SRC_BIT |
                   ...
                   &hostMemory, bufferSize, computeInput.data());
    ...
    */
    {
      ...
      VkDescriptorBufferInfo bufferDescriptor = {deviceBuffer, 0,
                                                 VK_WHOLE_SIZE};
      std::vector<VkWriteDescriptorSet> computeWriteDescriptorSets = {
          vks::initializers::writeDescriptorSet(
              descriptorSet, VK_DESCRIPTOR_TYPE_STORAGE_BUFFER, 0,
              &bufferDescriptor),
      };
      ...
      shaderStage.module = vks::tools::loadShader(
          ...
          ASSET_PATH "shaders/computeheadless/headless.comp.spv", device);
#else
      shaderStage.module = vks::tools::loadShader(
          ASSET_PATH "shaders/computeheadless/headless.comp.spv", device);
#endif
    ...
    */
    {
      ...
      vkCmdPipelineBarrier(commandBuffer, VK_PIPELINE_STAGE_TRANSFER_BIT,
                           VK_PIPELINE_STAGE_HOST_BIT, VK_FLAGS_NONE, 0,
                           nullptr, 1, &bufferBarrier, 0, nullptr);
