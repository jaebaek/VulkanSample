...
public:
  ...
  struct {
    ...
    VkDescriptorSet descriptorSetPreCompute;  // Image display shader bindings
                                              // before compute shader image
                                              // manipulation
    VkDescriptorSet descriptorSetPostCompute; // Image display shader bindings
                                              // after compute shader image
                                              // manipulation
  ...
  void buildCommandBuffers() {
    ...
    for (int32_t i = 0; i < drawCmdBuffers.size(); ++i) {
      ...
      VkViewport viewport = vks::initializers::viewport(
          (float)width * 0.5f, (float)height, 0.0f, 1.0f);
  ...
  void updateUniformBuffers() {
    ...
    uboVS.projection = glm::perspective(
        glm::radians(60.0f), (float)width * 0.5f / (float)height, 0.1f, 256.0f);
    glm::mat4 viewMatrix =
