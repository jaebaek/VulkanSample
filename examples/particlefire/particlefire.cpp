...
public:
  ...
  void buildCommandBuffers() {
    ...
    for (int32_t i = 0; i < drawCmdBuffers.size(); ++i) {
      ...
      vkCmdBindDescriptorSets(drawCmdBuffers[i],
                              ...
                              0, 1, &descriptorSets.environment, 0, NULL);
      ...
      vkCmdBindVertexBuffers(drawCmdBuffers[i], VERTEX_BUFFER_BIND_ID, 1,
                             &models.environment.vertices.buffer, offsets);
      vkCmdBindIndexBuffer(drawCmdBuffers[i], models.environment.indices.buffer,
                           0, VK_INDEX_TYPE_UINT32);
      vkCmdDrawIndexed(drawCmdBuffers[i], models.environment.indexCount, 1, 0,
                       0, 0);
  ...
  void preparePipelines() {
    ...
    // Particle rendering pipeline
    {
      // Shaders
      shaderStages[0] =
          loadShader(getAssetPath() + "shaders/particlefire/particle.vert.spv",
                     VK_SHADER_STAGE_VERTEX_BIT);
      shaderStages[1] =
          loadShader(getAssetPath() + "shaders/particlefire/particle.frag.spv",
  ...
  void updateUniformBuffers() {
    ...
    uboVS.model =
        viewMatrix * glm::translate(uboVS.model, glm::vec3(0.0f, 15.0f, 0.0f));
