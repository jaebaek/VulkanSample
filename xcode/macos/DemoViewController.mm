...
const std::string VulkanExampleBase::getAssetPath() {
  return [NSBundle.mainBundle.resourcePath stringByAppendingString:@"/data/"]
      .UTF8String;
}
...
/** Indicates that the view wants to draw using the backing layer instead of
 * using drawRect:.  */
...
/** If the wantsLayer property is set to YES, this method will be invoked to
